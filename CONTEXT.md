...
_Avoid_: editar/mutar a base compartilhada; "versão" (que é regeneração de IA); tratar a edição da própria receita pelo Owner como derivação (ela é in-place).
