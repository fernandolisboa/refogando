...
_Avoid_: Filtro (para a ação completa); Pesquisa (usar Busca); Find; a Busca disparar geração automática no zero-resultado (é ponte explícita, não Busca-que-cria).
