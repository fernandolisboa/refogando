...
- A tradução (`TRANSLATION_MODEL`) manda `thinking: disabled`; Opus 5.5 e Fable recusam isso, então subir a tradução para eles exige tirar o parâmetro.
- Fable é mais lento e ~2,5× o preço do Opus 5.5: medir latência antes de deixá-lo como default (prazo de 50s).
