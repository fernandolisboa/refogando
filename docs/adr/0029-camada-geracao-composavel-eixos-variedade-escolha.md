...
4. **Dificuldade passa a modular o texto.** Deixa de ser número morto no user prompt e vira comportamento (mais/menos passos, técnica mais/menos avançada) — via o mesmo mecanismo de fragmento.
