...
export const enUS: Messages = {
  ...
  listaCompras: {
    ...
    subtitulo: 'Add items by hand, edit the quantity, or remove what you no longer need.',
    vazio: 'Your list is empty. Add an item below.',
    nomeItem: 'Item',
    ...
    semQuantidade: 'no quantity',
    erroNomeInvalido: 'Choose a name for the item (up to 200 characters).',
    erroQuantidadeInvalida: 'Invalid quantity — use a number greater than zero.',
    erroUnidadeInvalida: 'Invalid unit.',
    erro: 'Something went wrong. Try again.',
    erroCarregar: 'Could not load your list. Try again.',
