...
export const ptBR = {
  ...
  admin: {
    ...
    // ADR-0034: modelo + esforço + thinking POR TAREFA de IA de texto (config-section.tsx).
    configTitulo: 'Modelos de IA de texto',
    configDescricao:
      'Cada tarefa tem o próprio modelo e ajustes, guardados por modelo. Ao salvar, uma chamada de teste confirma que a Anthropic aceita a combinação.',
    tarefaGeracaoTitulo: 'Geração de receita',
    tarefaGeracaoDescricao:
      'Receitas novas, variações e a conversa com o chef.',
    tarefaTraducaoTitulo: 'Tradução',
    tarefaTraducaoDescricao:
      'Tradução de receitas entre pt-BR e en-US. Tarefa fiel: thinking desligado por padrão.',
    tarefaExtracaoTitulo: 'Extração de ingredientes',
    tarefaExtracaoDescricao:
      'Lê a lista de ingredientes colada pelo usuário. Thinking desligado por padrão.',
    modeloLabel: 'Modelo',
    modeloForaDaLista: 'em uso, fora da lista atual',
    salvar: 'Salvar',
    salvando: 'Salvando…',
    salvo: 'Configuração salva.',
    erroModelo: 'Modelo inválido.',
    esforcoLabel: 'Esforço',
    esforcoLow: 'Baixo',
    esforcoMedium: 'Médio',
    esforcoHigh: 'Alto',
    esforcoXhigh: 'Muito alto',
    esforcoMax: 'Máximo',
    ...
    slaMarcarAtendido: 'Marcar como atendido',
    slaRecusar: 'Recusar',
    slaMotivoLabel: 'Motivo da recusa',
    slaConfirmarRecusa: 'Confirmar recusa',
    slaCancelar: 'Cancelar',
    slaEncerrarErro: 'Não foi possível encerrar o pedido. Tente de novo.',
